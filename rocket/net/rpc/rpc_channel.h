#ifndef ROCEKT_NET_RPC_RPC_CHANNEL_H
#define ROCEKT_NET_RPC_RPC_CHANNEL_H
...
#define CALLRPC(addr, stub_name ,method_name, controller, request, response, closure) \
    ...
    public:
        ...
        TimeEvent::s_ptr getTimeEvent();

    private:
        NetAddr::s_ptr m_peer_addr{nullptr};
        NetAddr::s_ptr m_local_addr{nullptr};

        // 直接当作指针传入可能出现在函数调用过程析构  加入类的内部
        ...
        TimeEvent::s_ptr m_time_event{nullptr};
    };
}
