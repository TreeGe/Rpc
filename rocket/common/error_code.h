...
const int ERROR_FAILED_GET_REPLY = SYS_ERROR_PREFIX(0002); //获取回报失败

const int ERROR_FAILED_DESERIALIZE = SYS_ERROR_PREFIX(0003); //反序列化失败
const int ERROR_FAILED_SERIALIZE = SYS_ERROR_PREFIX(0004); //反序列化失败

const int ERROR_FAILED_ENCODE = SYS_ERROR_PREFIX(0005); //encoder failed
...
const int ERROR_SERIVIE_NOT_FOUND = SYS_ERROR_PREFIX(0008); // service不存在
